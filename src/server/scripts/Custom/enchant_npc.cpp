/* http://paste2.org/p/2039780 */
/* ScriptData
SDName: Enchant_NPC
SD%Complete: 100
SDComment: Enchants items via a series of gossip prompts.
...
enum Enchants
{
    ...
    ENCHANT_GLOVES_GREATER_ASSAULT      = 3829,
...
void Enchant(Player* player, Creature* creature, Item* item, uint32 enchantid)
{
    ...
    switch (enchantid)
    {
        ...
        case ENCHANT_WEP_MASSACRE:
            ...
            {
                creature->MonsterWhisper("That isn't a two-handed weapon, fool!", player->GetGUID());
                return;
            }
            break;
        ...
        case ENCHANT_SHIELD_TITANIUM_SPIKE:
            ...
            {
                creature->MonsterWhisper("That isn't a shield, fool!", player->GetGUID());
                return;
            }
            break;
        ...
        case ENCHANT_RANGED_SUN_SCOPE:
            ...
            {
                creature->MonsterWhisper("That isn't a ranged weapon, fool!", player->GetGUID());
                return;
            }
            break;
        default:
    ...
    char* message;
    asprintf(&message, "Item %s has been successfully enchanted.", item_name);
    creature->MonsterWhisper(message, player->GetGUID());
}
 
class enchant_npc : public CreatureScript
{
    public:
        enchant_npc() : CreatureScript("enchant_npc") { }
        ...
        void ShowMainMenu(Player* player, Creature* creature)
        {
            ...
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, "Enchant Belt", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 10);
        ...
        void Show1HWeaponMenu(Player* player, Creature* creature)
        {
            ...
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_1, "Accuracy", GOSSIP_SENDER_MAIN,
                ENCHANT_WEP_ACCURACY);
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_1, "Black Magic", GOSSIP_SENDER_MAIN, 
                ENCHANT_WEP_BLACK_MAGIC);
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_1, "Battlemaster", GOSSIP_SENDER_MAIN,
                ENCHANT_WEP_BATTLEMASTER);
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_1, "Berserking", GOSSIP_SENDER_MAIN, 
                ENCHANT_WEP_BERSERKING);
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_1, "Exceptional Agility", GOSSIP_SENDER_MAIN,
                ENCHANT_WEP_AGILITY_1H);
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_1, "Exceptional Spirit", GOSSIP_SENDER_MAIN, 
                ENCHANT_WEP_SPIRIT);
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_1, "Executioner", GOSSIP_SENDER_MAIN, 
                ENCHANT_WEP_EXECUTIONER);
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_1, "Icebreaker", GOSSIP_SENDER_MAIN, 
                ENCHANT_WEP_ICEBREAKER);
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_1, "Lifeward", GOSSIP_SENDER_MAIN,
                ENCHANT_WEP_LIFEWARD);
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_1, "Mighty Spellpower", GOSSIP_SENDER_MAIN,
                ENCHANT_WEP_MIGHTY_SPELL_POWER);
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_1, "Mongoose", GOSSIP_SENDER_MAIN, 
                ENCHANT_WEP_MONGOOSE);
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_1, "Superior Potency", GOSSIP_SENDER_MAIN,
                ENCHANT_WEP_POTENCY);
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_1, "Titanguard", GOSSIP_SENDER_MAIN, 
                ENCHANT_WEP_TITANGUARD);
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_1, "Titanium Weapon Chain", GOSSIP_SENDER_MAIN, 
        ...
        void Show2HWeaponMenu(Player* player, Creature* creature)
        {
            ...
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_1, "Major Agility", GOSSIP_SENDER_MAIN, 
                ENCHANT_WEP_AGILITY_2H);
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_1, "Massacre", GOSSIP_SENDER_MAIN,
        ...
        {
            player->PlayerTalkClass->ClearMenus();
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_1, "Defense", GOSSIP_SENDER_MAIN, 
                ENCHANT_SHIELD_DEFENSE);
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_1, "Greater Intellect", GOSSIP_SENDER_MAIN, 
                ENCHANT_SHIELD_INTELLECT);
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_1, "Major Stamina", GOSSIP_SENDER_MAIN,
                ENCHANT_SHIELD_MAJOR_STAMINA);
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_1, "Resilience", GOSSIP_SENDER_MAIN,
                ENCHANT_SHIELD_RESILIENCE);
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_1, "Titanium Plating", GOSSIP_SENDER_MAIN, 
                ENCHANT_SHIELD_TITANIUM_PLATING);
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_1, "Titanium Shield Spike", GOSSIP_SENDER_MAIN, 
        ...
        {
            player->PlayerTalkClass->ClearMenus();
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_1, "Arcanum of Blissful Mending", GOSSIP_SENDER_MAIN, 
                ENCHANT_HEAD_BLISSFUL_MENDING);
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_1, "Arcanum of Burning Mysteries", GOSSIP_SENDER_MAIN, 
                ENCHANT_HEAD_BURNING_MYSTERIES);
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_1, "Arcanum of Dominance", GOSSIP_SENDER_MAIN, 
                ENCHANT_HEAD_DOMINANCE);
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_1, "Arcanum of The Savage Gladiator", GOSSIP_SENDER_MAIN, 
                ENCHANT_HEAD_SAVAGE_GLADIATOR);
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_1, "Arcanum of The Stalwart Protector", GOSSIP_SENDER_MAIN,
                ENCHANT_HEAD_STALWART_PROTECTOR);
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_1, "Arcanum of Torment", GOSSIP_SENDER_MAIN,
                ENCHANT_HEAD_TORMENT);
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_1, "Arcanum of Triumph", GOSSIP_SENDER_MAIN, 
        ...
        void ShowShouldersMenu(Player* player, Creature* creature)
        {
            ...
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_1, "Greater Inscription of the Axe", GOSSIP_SENDER_MAIN, 
                ENCHANT_SHOULDER_GREATER_AXE);
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_1, "Greater Inscription of the Crag", GOSSIP_SENDER_MAIN, 
                ENCHANT_SHOULDER_GREATER_CRAG);
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_1, "Greater Inscription of the Pinnacle", GOSSIP_SENDER_MAIN, 
                ENCHANT_SHOULDER_GREATER_PINNACLE);
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_1, "Greater Inscription of the Gladiator", GOSSIP_SENDER_MAIN, 
                ENCHANT_SHOULDER_GREATER_GLADIATOR);
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_1, "Greater Inscription of the Storm", GOSSIP_SENDER_MAIN, 
                ENCHANT_SHOULDER_GREATER_STORM);
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_1, "Inscription of Dominance", GOSSIP_SENDER_MAIN, 
                ENCHANT_SHOULDER_DOMINANCE);
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_1, "Inscription of Triumph", GOSSIP_SENDER_MAIN, 
        ...
        void ShowCloakMenu(Player* player, Creature* creature)
        {
            ...
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_1, "Wisdom", GOSSIP_SENDER_MAIN, 
                ENCHANT_CLOAK_WISDOM);
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_1, "Titanweave", GOSSIP_SENDER_MAIN,
                ENCHANT_CLOAK_TITANWEAVE);
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_1, "Spell Piercing", GOSSIP_SENDER_MAIN, 
                ENCHANT_CLOAK_SPELL_PIERCING);
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_1, "Mighty Armor", GOSSIP_SENDER_MAIN,
                ENCHANT_CLOAK_MIGHTY_ARMOR);
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_1, "Major Agility", GOSSIP_SENDER_MAIN, 
                ENCHANT_CLOAK_MAJOR_AGILITY);
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_1, "Greater Speed", GOSSIP_SENDER_MAIN, 
        ...
        {
            player->PlayerTalkClass->ClearMenus();
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_1, "Exceptional Mana", GOSSIP_SENDER_MAIN, 
                ENCHANT_CHEST_EXCEPTIONAL_MANA);
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_1, "Greater Mana Restoration", GOSSIP_SENDER_MAIN, 
                ENCHANT_CHEST_GREATER_MANA_RESTO);
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_1, "Exceptional Resilience", GOSSIP_SENDER_MAIN, 
                ENCHANT_CHEST_EXCEPTIONAL_RESILIENCE);
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_1, "Super Health", GOSSIP_SENDER_MAIN, 
                ENCHANT_CHEST_SUPER_HEALTH);
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_1, "All Stats", GOSSIP_SENDER_MAIN, 
        ...
        {
            player->PlayerTalkClass->ClearMenus();
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_1, "Greater Assault", GOSSIP_SENDER_MAIN, 
                ENCHANT_BRACER_GREATER_ASSAULT);
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_1, "Exceptional Intellect", GOSSIP_SENDER_MAIN, 
                ENCHANT_BRACER_EXCEPTIONAL_INTELLECT);
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_1, "Major Spirit", GOSSIP_SENDER_MAIN, 
                ENCHANT_BRACER_MAJOR_SPIRIT);
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_1, "Expertise", GOSSIP_SENDER_MAIN, 
                ENCHANT_BRACER_EXPERTISE);
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_1, "Greater Stats", GOSSIP_SENDER_MAIN, 
                ENCHANT_BRACER_GREATER_STATS);
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_1, "Superior Spellpower", GOSSIP_SENDER_MAIN, 
        ...
        {
            player->PlayerTalkClass->ClearMenus();
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, "Armsman", GOSSIP_SENDER_MAIN, 
                ENCHANT_GLOVES_ARMSMAN);
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, "Exceptional Spellpower", GOSSIP_SENDER_MAIN, 
                ENCHANT_GLOVES_EXCEPTIONAL_SPELLPOWER);
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, "Expertise", GOSSIP_SENDER_MAIN, 
                ENCHANT_GLOVES_EXPERTISE);
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, "Greater Assault", GOSSIP_SENDER_MAIN, 
                ENCHANT_GLOVES_GREATER_ASSAULT);
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, "Major Agility", GOSSIP_SENDER_MAIN, 
                ENCHANT_GLOVES_MAJOR_AGILITY);
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, "Precision", GOSSIP_SENDER_MAIN, 
                ENCHANT_GLOVES_PRECISION);
            if (player->HasSkill(SKILL_BLACKSMITHING) && player->GetSkillValue(SKILL_BLACKSMITHING) >= 450)
                player->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, "Socket Gloves", GOSSIP_SENDER_MAIN, 
                    ENCHANT_GLOVES_SOCKET_GLOVES);
            if (player->HasSkill(SKILL_ENGINEERING) && player->GetSkillValue(SKILL_ENGINEERING) >= 450)
            {
                player->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, "Hand-Mounted Pyro Rocket", GOSSIP_SENDER_MAIN, 
                    ENCHANT_GLOVES_PYROROCKET);
                player->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, "Hyperspeed Accelerators", GOSSIP_SENDER_MAIN, 
        ...
        {
            player->PlayerTalkClass->ClearMenus();
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, "Eternal Belt Buckle", GOSSIP_SENDER_MAIN, 
                ENCHANT_BELT_ETERNAL_BELT_BUCKLE);
            if (player->HasSkill(SKILL_ENGINEERING) && player->GetSkillValue(SKILL_ENGINEERING) >= 450)
                player->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, "Frag Belt", GOSSIP_SENDER_MAIN, 
        ...
        {
            player->PlayerTalkClass->ClearMenus();
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, "Frosthide Leg Armor", GOSSIP_SENDER_MAIN, 
                ENCHANT_LEGS_FROSTHIDE_ARMOR);
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, "Icescale Leg Armor", GOSSIP_SENDER_MAIN, 
                ENCHANT_LEGS_ICESCALE_ARMOR);
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, "Earthen Leg Armor", GOSSIP_SENDER_MAIN, 
                ENCHANT_LEGS_EARTHEN_ARMOR);
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, "Sapphire Spellthread", GOSSIP_SENDER_MAIN, 
                ENCHANT_LEGS_SAPPHIRE_SPELLTHREAD);
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, "Brilliant Spellthread", GOSSIP_SENDER_MAIN, 
        ...
        {
            player->PlayerTalkClass->ClearMenus();
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, "Icewalker", GOSSIP_SENDER_MAIN, 
                ENCHANT_BOOTS_ICEWALKER);
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, "Greater Assault", GOSSIP_SENDER_MAIN, 
                ENCHANT_BOOTS_GREATER_ASSAULT);
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, "Greater Fortitude", GOSSIP_SENDER_MAIN, 
                ENCHANT_BOOTS_GREATER_FORTITUDE);
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, "Greater Spirit", GOSSIP_SENDER_MAIN, 
                ENCHANT_BOOTS_GREATER_SPIRIT);
            if (player->HasSkill(SKILL_ENGINEERING) && player->GetSkillValue(SKILL_ENGINEERING) >= 450)
                player->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, "Nitro Boosts", GOSSIP_SENDER_MAIN, 
                    ENCHANT_BOOTS_NITRO_BOOSTS);
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, "Superior Agility", GOSSIP_SENDER_MAIN, 
                ENCHANT_BOOTS_SUPERIOR_AGILITY);
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, "Tuskarr's Vitality", GOSSIP_SENDER_MAIN, 
        ...
        {
            player->PlayerTalkClass->ClearMenus();
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, "Assault", GOSSIP_SENDER_MAIN, 
                ENCHANT_RING_ASSAULT);
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, "Greater Spellpower", GOSSIP_SENDER_MAIN, 
                ENCHANT_RING_GREATER_SPELLPOWER);
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, "Stamina", GOSSIP_SENDER_MAIN, 
        ...
        {
            player->PlayerTalkClass->ClearMenus();
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, "Heartseeker Scope", GOSSIP_SENDER_MAIN, 
                ENCHANT_RANGED_HEARTSEEKER_SCOPE);
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, "Sun Scope", GOSSIP_SENDER_MAIN, 
